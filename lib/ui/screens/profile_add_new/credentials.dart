...
class CredentialsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          CredentialsCubit(CredentialsProvider())..fillFields(credential),
      child: Scaffold(
        appBar: AppBar(
        ...
        floatingActionButton: credential != null
            ? null
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const CustomTitle(title: "credentials_cat"),
                            CustomInputField(
                            ...
                            const CustomTitle(title: "credentials_name"),
                            CustomInputField(
                            ...
                            const CustomTitle(title: "credentials_Number"),
                            CustomInputField(
                            ...
                            const CustomTitle(title: "issue_date"),
                            CustomDatePicker(
                              onTap: () {
                            ...
                            const CustomTitle(title: "expire_date"),
                            CustomDatePicker(
                              onTap: () {
