...
class RedExceptionHandler {
  static  handleFlutterError(FlutterErrorDetails details) {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text('please wait some time until  the error is resolved and try again later', textAlign: TextAlign.center),
          ],
        ),
      ),
    );
