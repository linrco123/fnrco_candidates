...
class ContactsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ContactsTypeCubit(ContactsProvider())
        ..getContacts()
        ..fillFields(contact),
      child: Scaffold(
        appBar: AppBar(
        ...
        floatingActionButton: contact != null
            ? null
            : Builder(builder: (context) {
                return Padding(
                  ...
                  child: FloatingActionButton(
                    onPressed: () {
                      BlocProvider.of<ContactsTypeCubit>(context)
                          .addNewContact();
                    },
                  ...
                  children: [
                    state is ContactsGettingContactTypeLoadingState
                        ...
                        : CustomDropDownSearch(
                            selectedItem: cubit.contactTypeID,
                    ...
                    const CustomTitle(title: 'contact_value'),
                    CustomInputField(
