...
import 'package:fnrco_candidates/logic/cubit/home/home_cubit.dart';
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: _buildAppBar(context, homeCubit.selectedIndex),
            drawer: homeCubit.selectedIndex != 0
                ? null
            ...
            body: _buildBody(context, homeCubit.selectedIndex),
            bottomNavigationBar: StylishBottomBar(
              ...
              //   ),
              // ),
              items: homeCubit.navBarItems,
              fabLocation: StylishBarFabLocation.center,
              hasNotch: true,
              
              currentIndex: homeCubit.selectedIndex,
              onTap: (index) => homeCubit.changeState(index),
            ),
