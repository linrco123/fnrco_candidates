        ...
        return Scaffold(
            ...
            children: [
              IconButton(
                  ...
                  onPressed: () {
                    ...
                    BlocProvider.of<JobOfferCubit>(context).downloadJobOffer(
                        'https://kdamat.com/servant/cv/download/815');
                  },
                  icon: Icon(
          ...
          body: BlocConsumer<JobOfferCubit, JobOfferState>(
            listener: (context, state) {
              ...
              if (state is JobOfferDownloadPDFLoadingState) {
                showDialog(
                  context: context,
              ...
              if (state is JobOfferDownloadPDFSuccessState) {
                Navigator.of(context).pop();
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text('Job Offer downloaded successfully'),
                  backgroundColor: AppColors.success,
                ));
              }
              if (state is JobOfferDownloadPDFFailureState) {
                Navigator.of(context).pop();
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text('Job Offer hasn\'t been got'),
                  backgroundColor: AppColors.primary,
                ));
              }
            },
              ...
              return Stack(
                children: [
                  ...
                  if (state is GeneratingPDFErrorState)
                    Center(
                        child:
                            Text('Errorrrrrrrrrrrrrrrrrrrrrrrrr !!!!!!!!!!')),
